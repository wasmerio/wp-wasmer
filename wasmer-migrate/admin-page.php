        ...
        <section class="wasmer-migrate-panel" data-panel="auto">
            <div class="wasmer-migrate-start">
                <label class="wasmer-migrate-start-field" for="wasmer-migrate-auto-app-name">
                    ...
                    <input type="text" id="wasmer-migrate-auto-app-name" value="<?php echo esc_attr(wasmer_migrate_auto_random_app_name()); ?>" maxlength="36" autocomplete="off" spellcheck="false" aria-describedby="wasmer-migrate-auto-app-name-help">
                    <small id="wasmer-migrate-auto-app-name-help">A randomized name is generated by default. Spaces and unsupported characters in custom names will be converted to hyphens.</small>
                </label>
