# WP Wasmer Documentation

Use the pages below depending on what you are trying to do with the plugin.

- [REST API reference](rest-api.md)
  The HTTP endpoints exposed by the plugin, including request formats, auth expectations, status codes, and response behavior.
...
For local setup and test commands, see the [root README](../README.md).
